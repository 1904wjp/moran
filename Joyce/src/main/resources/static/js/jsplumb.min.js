(function () {
                ...
                if (b && this.isEnabled() && this.canDrag()) {
                    ...
                    if (d) {
                        if (u) {
                            ...
                            var e = f(this.el);
                            s.style.left = e.left + "px", s.style.top = e.top + "px", this.params.addClass(s, p.clonedDrag), document.body.appendChild(s)
                        } else s = this.el;
        ...
        this.bind = function (b, c, d) {
            ...
            if (c) e.unshift(arguments); else {
                if (c = !0, !b && a[g]) {
                    ...
                    if (!this.shouldFireEvent || this.shouldFireEvent(g, h, i)) for (; !m && k > l && n !== !1;) {
    ...
    var m = 0, n = function () {
        ...
        this.version = "2.6.8", d && p.extend(this.Defaults, d), this.logEnabled = this.Defaults.LogEnabled, this._connectionTypes = {}, this._endpointTypes = {}, b.EventGenerator.apply(this);
        ...
        var ua = function (a, b, c, d, e) {
            ...
            return e.scope = e.scope || d.scope || f.Defaults.Scope, e[l] = b.wrap(e[l], j, !0), h && (e[a.jsPlumb.dragEvents.over] = function () {
                return !0
    ...
    a.jsPlumb.extend(a.jsPlumbInstance.prototype, {
        headless: !1, pageLocation: d, screenLocation: e, clientLocation: f, getDragManager: function () {
            ...
            return ["svg"]
        }, getClass: l, addClass: function (a, b) {
        ...
        var d = {}, e = {}, f = {}, g = {},
            ...
            o = function (a, b, c, d, e, f) {
                ...
                for (var o = k[0].source, p = k[0].target, q = 0; q < k.length && (o = !e.isContinuous || e.isEdgeSupported(k[q].source) ? k[q].source : null,
                    p = !f.isContinuous || f.isEdgeSupported(k[q].target) ? k[q].target : null, null == o || null == p); q++) ;
    ...
    var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = "Straight", e = "Arc", f = function (a) {
            ...
            m = (a.loopbackRadius || 25, function (a) {
                ...
                for (var f, h, i, j = null, k = 0; k < b.length - 1; k++) {
                    if (j = j || q(b[k]), f = q(b[k + 1]), h = n(j), i = n(f), l > 0 && j[4] !== f[4]) {
                        var m = Math.min(l, p(j), p(f));
                        j[2] -= h[0] * m, j[3] -= h[1] * m, f[0] += i[0] * m, f[1] += i[1] * m;
                        var o = h[1] === i[0] && 1 === i[0] || h[1] === i[0] && 0 === i[0] && h[0] !== i[1] || h[1] === i[0] && -1 === i[0],
                            r = f[1] > j[3] ? 1 : -1, s = f[0] > j[2] ? 1 : -1, t = r === s,
                            u = t && o || !t && !o ? f[0] : j[2], v = t && o || !t && !o ? j[3] : f[1];
                        ...
                        var w = j[2] === j[0] ? 0 : j[2] > j[0] ? c.lw / 2 : -(c.lw / 2),
                            x = j[3] === j[1] ? 0 : j[3] > j[1] ? c.lw / 2 : -(c.lw / 2);
                        g.addSegment(a, d, {x1: j[0] - w, y1: j[1] - x, x2: j[2] + w, y2: j[3] + x})
                    }
                    j = f
                }
        ...
        this._compute = function (a, b) {
            ...
            var d = this.getGeometry(), e = [a.x, a.y], l = [a.x + a.w, a.y + a.h];
            if ((this.hasBeenEdited() || this.isEditing()) && null != d && null != d.segments && d.segments.length > 0) c = d.segments, g.setGeometry({
                segments: c,
                sourcePos: e,
                targetPos: l
            }); else {
                var m = function () {
                        ...
                        perpendicular: m, orthogonal: m, opposite: function (b) {
                            var c = a, d = "x" === b ? 0 : 1, e = {
                                x: function () {
                    ...
                    }, p = n[a.anchorOrientation](a.sourceAxis), q = "x" === a.sourceAxis ? 0 : 1,
                    s = "x" === a.sourceAxis ? 1 : 0, t = p[q], u = p[s], v = p[q + 2], w = p[s + 2];
                o(c, p[0], p[1], a);
                var x = a.startStubX + (a.endStubX - a.startStubX) * h,
                    y = a.startStubY + (a.endStubY - a.startStubY) * h, z = {x: [0, 1], y: [1, 0]}, A = {
                        perpendicular: function (b) {
                            var c = a, d = {
                                ...
                                g = {x: [[c.endStubX, c.startStubY]], y: [[c.startStubX, c.endStubY]]}, h = {
                                    ...
                                    x: [[c.startStubX, y], [c.endStubX, y], [c.endStubX, c.endStubY]],
                                    y: [[x, c.startStubY], [x, c.endStubY], [c.endStubX, c.endStubY]]
                                }, j = {x: [c.startStubY, c.endStubY], y: [c.startStubX, c.endStubX]}, k = z[b][0], l = z[b][1],
                                m = c.so[k] + 1, n = c.to[l] + 1,
                                o = -1 === c.to[l] && j[b][1] < j[b][0] || 1 === c.to[l] && j[b][1] > j[b][0],
                                p = e[b][m][0], q = e[b][m][1], r = d[b][m][n];
                            ...
                            return !k || 1 === h.so[q] && d > f || -1 === h.so[q] && f > d ? {
                                x: [[d, y], [f, y]],
                                y: [[x, d], [x, f]]
                            }[c] : 1 === h.so[q] && f > d || -1 === h.so[q] && d > f ? {
                                x: [[x, h.sy], [x, h.ty]],
                                y: [[h.sx, y], [h.tx, y]]
                            }[c] : void 0
                        }
                    }, B = A[a.anchorOrientation](a.sourceAxis, t, u, v, w);
                if (B) for (var C = 0; C < B.length; C++) o(c, B[C][0], B[C][1], a);
    ...
    var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = function (a, b, c, d) {
        ...
        this._computeBezier = function (a, b, j, k, l, m) {
            ...
            (this.hasBeenEdited() || this.isEditing()) && null != z ? (r = z.controlPoints[0][0], t = z.controlPoints[0][1], s = z.controlPoints[1][0], u = z.controlPoints[1][1]) : (c = e(v, w, x, b.sourcePos, b.targetPos, g, g, y, i), r = c[0], s = c[0], t = c[1], u = c[1], f.setGeometry({
                ...
                quadrant: x,
                curviness: g
            }, !0)), f.addSegment(this, "Bezier", {x1: p, y1: q, x2: n, y2: o, cp1x: r, cp1y: t, cp2x: s, cp2y: u})
        }
    };
    ...
    }, c.extend(b.Connectors.svg.StateMachine, [b.Connectors.StateMachine, b.ConnectorRenderers.svg]), b.Endpoints.svg.Image = b.Endpoints.Image, b.Endpoints.svg.Blank = b.Endpoints.Blank, b.Overlays.svg.Label = b.Overlays.Label, b.Overlays.svg.Custom = b.Overlays.Custom;
    var B = function (a, c) {
        a.apply(this, c), b.jsPlumbUIComponent.apply(this, c),
